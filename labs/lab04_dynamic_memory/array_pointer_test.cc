...
ArrayPointerTest::ArrayPointerTest(int count) {
  ...
  //ducks1 = new Duck(count_);
  //
    cout << "size of Duck " << sizeof(Duck)<<endl;
  cout << "size of ducks1_ " << sizeof(ducks1_)<<endl;
  cout << "-------------" <<endl;
  ...
  cout << "size of ducks2_ " << sizeof(ducks2_)<<endl;
  ...
  cout << "size of ducks3_ " << sizeof(ducks3_)<<endl;
  for(int i = 0; i < count_;i++){
      *(ducks3_ + i) = new Duck;
  }
  ...
  cout << "size of ducks4_ " << sizeof(ducks4_)<<endl;
